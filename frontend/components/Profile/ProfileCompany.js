							...
							this.state.professional.map((professional, i) => (
								...
								>
									...
									<View style={styles.paragraphText}>
										<Text style={[ styles.servicesList, { fontSize: 20, marginTop: 10 } ]}>
											Services
										</Text>
									...
									>
										<Text style={[ styles.servicesList, { fontSize: 20 } ]}>Description</Text>
										<Text>{professional.longDescription}</Text>
									</View>
									<View style={styles.paragraphText}>
										<Text style={[ styles.servicesList, { fontSize: 20 } ]}>Contact</Text>
										<Text style={styles.infoText}>{professional.address.street}</Text>
										<Text style={styles.infoText}>{professional.address.zip}</Text>
										<Text style={styles.infoText}>{professional.address.city}</Text>
										<Text style={styles.infoText}>{professional.email}</Text>
									</View>

									<View style={[ styles.paragraphText, { paddingBottom: 10 } ]}>
										<Text style={[ styles.servicesList, { fontSize: 20 } ]}>Projects</Text>
									</View>
