...
import { View, TextInput, Text, StyleSheet, Button, TouchableHighlight, Picker } from 'react-native';
...
export default class RequestFormular extends React.Component {
	...
	onNewEditedText = (editedText) => {
		this.setState({ title: editedText });
	};
	render() {
		return (
			<KeyboardAwareScrollView contentContainerStyle={{ flex: 1 }}>
				<View style={styles.container}>
					...
					<Picker
						...
						onValueChange={this.onNewEditedText}
						mode="dropdown"
						style={styles.inputs}
						/* onValueChange={(value) => onChangeValue('services', value)} */
					>
						<Picker.Item label="please select a service" value="" />
          ...
          /> */}
					...
					<TextInput
						...
						onChangeText={(editedText) => this.setState({ description: editedText })}
						onContentSizeChange={(e) => this.setState({ height: e.nativeEvent.contentSize.height + 20 })}
						style={[
							styles.inputs,
							{
